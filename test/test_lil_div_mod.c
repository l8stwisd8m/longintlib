...
Test(test_lil_div_mod, modulus_div_of_positive_values_less_than_modulus) {
    uint64_t arr_a[LIL_256_BIT] = {0};
...
Test(test_lil_div_mod, modulus_div_of_negative_values_less_than_modulus) {
    uint64_t arr_a[LIL_256_BIT] = {0};
...
Test(test_lil_div_mod, modulus_div_of_values_equal_to_modulus) {
    uint64_t arr_a[LIL_256_BIT] = {0};
...
Test(test_lil_div_mod, modulus_div_of_unequal_values) {
    uint64_t arr_a[LIL_256_BIT] = {0};
